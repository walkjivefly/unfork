...
#
EXPLORER="https://dogechain.info/api/v1/block/"
#
...
get_explorer_hash() {
    CHAINHASH=`curl --silent "${EXPLORER}$*" | jq .block.hash 2>/dev/null`
...
CHAINHIGH=`curl --silent https://dogechain.info/chain/Dogecoin/q/getblockcount 2>/dev/null`
